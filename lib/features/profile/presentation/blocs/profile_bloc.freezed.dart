...
abstract class _GetProfile implements ProfileEvent {
  factory _GetProfile() = _$_GetProfile;
}
...
abstract class $ProfileStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({FormzStatus status, UserModel profile});
}
...
class _$_ProfileState implements _ProfileState {
  _$_ProfileState(
      {this.status = FormzStatus.pure, this.profile = const UserModel()});
...
abstract class _ProfileState implements ProfileState {
  factory _ProfileState({final FormzStatus status, final UserModel profile}) =
      _$_ProfileState;
